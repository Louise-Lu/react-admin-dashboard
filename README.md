...
# 路由菜单点击交互实现 2 种方法
1. 使用 Link 修改左侧菜单内容，与子路由规则匹配实现路由切换
2. <Menu> onClick属性 + useNavigate()
```js
const GeekLayout = () => {
...
1. 把需要CDN缓存的文件 排除在打包之外 (react,react-dom)
2. 以CDN的方式重新引资源 (react,react-dom)
